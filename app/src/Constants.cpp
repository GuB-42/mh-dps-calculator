...
Constants::Constants() {
	...
	(*cond)[CONDITION_FULL_STAMINA_DELAYED] = 0.4;
	(*cond)[CONDITION_SLIDING] = 0.1;
	(*cond)[CONDITION_RECEIVED_DAMAGE] = 0.5;
	(*cond)[CONDITION_RECEIVED_DAMAGE_SECRET] = 0.6;
	(*cond)[CONDITION_BLIGHT_RECOVERY] = 0.1;
	(*cond)[CONDITION_AFTER_PERFECT_GUARD] = 0.0;
	(*cond)[CONDITION_FROST_AURA] = 0.4;
	(*cond)[CONDITION_CONSECUTIVE_ATTACKS] = 0.4;
