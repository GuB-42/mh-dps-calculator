...
enum Condition {
	...
	CONDITION_FULL_STAMINA_DELAYED,
	CONDITION_SLIDING,
	CONDITION_RECEIVED_DAMAGE,
	CONDITION_RECEIVED_DAMAGE_SECRET,
	CONDITION_BLIGHT_RECOVERY,
	CONDITION_AFTER_PERFECT_GUARD,
	CONDITION_FROST_AURA,
	CONDITION_CONSECUTIVE_ATTACKS,
